...
router.post('/admin/members/add', upload.single('image'), async (req, res) => {
  try {
...
router.get('/admin/members/edit/:id', async (req, res) => {
  try {
...
router.post('/admin/members/edit/:id', upload.single('image'), async (req, res) => {
  try {
    const { name, role, bio, linkedinUrl } = req.body;
    let imageUrl;
    if (req.file) {
...
router.post('/admin/members/delete/:id', async (req, res) => {
  try {
